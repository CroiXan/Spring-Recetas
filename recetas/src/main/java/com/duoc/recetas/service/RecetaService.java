...
public class RecetaService {
    ...
    public RecetaService(WebClient.Builder webClientBuilder) {
        ...
        instrucciones1.add(new Instruccion(1,
                "Cortar la carne en trozos de 250 gr., la cebolla en cuartos, la zanahoria en trozos, el tomate en gajos. Reservar"));
        instrucciones1.add(new Instruccion(2,
                "Calentar una olla a presión y adicionar aceite a punto humo, luego agregar los trozos de carne y sellar. Luego adicionar las verduras y seguir sofriendo por alrededorde 15 minutos."));
        instrucciones1.add(new Instruccion(3,
                "Una vez terminado el sofrito, adicionar la sal y las especias, continuar sofriendo por 5 minutos más."));
        instrucciones1.add(new Instruccion(4,
                "Pasado el tiempo, adicionar el vino blanco y dejar que de hervor. Luego adicionar agua hasta cubrir."));
        instrucciones1
                .add(new Instruccion(5, "Tapar la olla y una vez que de hervor cocinar por 45 minutos a fuego bajo."));
        instrucciones1.add(new Instruccion(6,
                "Al completar el tiempo, apagar el fuego y dejar que continúe su cocción al vapor sin fuego."));
        instrucciones1
                .add(new Instruccion(7, "Destapar la olla y servir acompañado de la guarnición que más te guste."));
